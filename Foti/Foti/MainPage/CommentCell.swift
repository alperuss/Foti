...
class CommentCell : UICollectionViewCell {
    var comment : Comment? {
        didSet{
            ...
            imgUserProfile.sd_setImage(with: URL(string: comment.user.profilePhotoURL))
    ...
    override init(frame: CGRect) {
        ...
        lblComment.anchor(top: topAnchor, bottom: bottomAnchor, leading: imgUserProfile.trailingAnchor, trailing: trailingAnchor, paddingTop: 5, paddingBottom: -5, paddingLeft: 10, paddingRight: 5, width: 0, height: 0)
    }
